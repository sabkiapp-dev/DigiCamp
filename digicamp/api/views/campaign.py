...
def add_to_phone_dialer(request):
    def process_request(request):
        ...
        print("hello adding to phone_dialer : ", api_key, phone_number)
        ...
        # if length of the phone number is greater than 10 and startng with 0, remove the 0
        if len(phone_number) > 10 and phone_number.startswith('0'):
            phone_number = phone_number[1:]
        # If length of the phone number is still greater than 10 or 
