...
def make_call_thread(final_dial_list):
    for dial in final_dial_list:
        ...
        try:
            auth_token = JWTTokenService.generate_token_for_host(dial['host'])
        except Exception as e:
            print(f"Error generating JWT token for {dial['host']}: {e}")
        ...
        url = f"https://{dial['host']}.sabkiapp.com/api/call/make"
